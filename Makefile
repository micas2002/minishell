...
SOURCES_LIST = main.c input.c input_utils.c lexer.c lexer_utils.c echo.c pwd.c cd.c signals.c env.c unset.c export.c free.c exit_status.c #execute_programs.c
